...
export class ReviewSimilarityService {
	...
	public async checkReviewsForSimilarity(reviewsFromDbForThatUser: Review[], reviewUserSubmitted: string): Promise<boolean> {
